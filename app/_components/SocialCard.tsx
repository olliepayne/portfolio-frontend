...
export default function SocialCard({ type, resume }: SocialCardProps) {
  switch (type) {
    case "LinkedIn":
      return (
        <div className="dark:border-off-black border-light-gray border-2 rounded-md p-3 relative dark:hover:border-primary-intense hover:border-primary transition-all">
          <a
