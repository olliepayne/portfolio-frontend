...
export default function ProjectCard({
  ...
  return (
    <div className="relative z-30 p-4 h-full group cursor-pointer bg-themeGray">
      ...
      <Link
        href={`/projects/${slug}`}
        className="mt-4 text-primaryIntense block opacity-0 transition-opacity before:z-20 before:absolute before:w-full before:h-full before:top-0 before:left-0 group-hover:opacity-100"
      >
        View project
      </Link>
    </div>
